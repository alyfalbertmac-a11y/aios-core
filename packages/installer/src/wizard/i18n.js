...
const TRANSLATIONS = {
  en: {
    ...
    proContactSupportEmail: 'Or contact support: support@synkra.ai',
  ...
  pt: {
    ...
    proContactSupportEmail: 'Ou entre em contato com o suporte: support@synkra.ai',
  ...
  es: {
    ...
    proContactSupportEmail: 'O contacte al soporte: support@synkra.ai',
