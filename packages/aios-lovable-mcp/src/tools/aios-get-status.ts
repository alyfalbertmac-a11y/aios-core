...
export const getStatusSchema = {
  ...
  description:
    'Check the status and progress of an async job or pipeline execution. Returns current phase, progress percentage, ETA, and any errors.',
  inputSchema: {
    ...
    properties: {
      job_id: {
        type: 'string',
        description:
          'The job ID returned by aios_full_pipeline or other async tools',
      },
    },
    required: ['job_id'],
  },
