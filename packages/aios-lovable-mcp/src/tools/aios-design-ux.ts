  ...
  inputSchema: {
    ...
    properties: {
      ...
      user_flows: {
        ...
        items: { type: 'string' },
        description:
          'Key user flows to design (e.g., ["Sign Up", "Create Project", "Share"])',
      },
      design_preferences: {
        type: 'object',
        description:
          'Design preferences (colors, fonts, style) - e.g., {"primary_color": "#3B82F6", "font_family": "Inter", "style": "modern"}',
      },
      accessibility_requirements: {
        type: 'array',
        items: { type: 'string' },
        description:
          'Specific accessibility requirements (e.g., ["WCAG 2.1 AA", "Dark mode support"])',
      },
      page_structure: {
        type: 'array',
        items: { type: 'string' },
        description:
          'Pages to design (e.g., ["Home", "Product", "Dashboard", "Settings"])',
      },
    },
