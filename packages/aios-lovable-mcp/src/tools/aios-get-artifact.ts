...
export const getArtifactSchema = {
  ...
  description:
    'Retrieve generated artifacts from a completed job (PRD, strategy, design system, architecture, code). Returns artifact URL, content, or downloadable package.',
  inputSchema: {
    ...
    properties: {
      ...
      format: {
        ...
        description:
          'Output format - json for structured data, markdown for docs, html for preview, zip for downloadable package (default: json)',
      },
    },
    required: ['job_id'],
  },
