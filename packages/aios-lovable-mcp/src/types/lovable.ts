...
export interface Architecture {
  ...
  api_design: { endpoints: ApiEndpoint[] };
...
export interface Strategy {
  ...
  target_segments: Array<{ segment: string; size: string; growth: string }>;
  positioning: {
...
export interface PRD {
  ...
  non_functional_requirements: Array<{ id: string; requirement: string; priority: string }>;
  success_metrics: string[];
}
