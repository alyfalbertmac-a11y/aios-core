...
class MCPHttpBridge {
     ...
     */
    async handleRequest(sessionId, jsonrpcRequest) {
        try {
            const { id, method, params } = jsonrpcRequest;
            console.error(`[MCPHttpBridge] Session ${sessionId}: ${method} (id: ${id})`);
        ...
        const tools = [
            {
                ...
                description: 'Generate comprehensive product strategy, market positioning, and PRD. Runs @pm agent.',
                inputSchema: {
                    type: 'object',
                    properties: {
            ...
            {
                name: 'aios_design_ux',
                description: 'Generate design system, component specs, wireframes, and accessibility guidelines.',
                inputSchema: {
                    type: 'object',
                    properties: {
            ...
            },
            {
                ...
                description: 'Produce a complete system architecture document including stack selection, data model, API design, and security.',
                inputSchema: {
                    type: 'object',
                    properties: {
            ...
            },
            {
                ...
                description: 'Generate production-ready implementation code (React/Next.js components, API routes, schemas).',
                inputSchema: {
                    type: 'object',
                    properties: {
                        spec: { type: 'string' },
            ...
            },
            {
                ...
                description: 'Execute end-to-end product development pipeline: strategy → design → architecture → code.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        product_name: { type: 'string' },
            ...
            },
            {
                ...
                description: 'Retrieve generated artifacts from a completed job (PRD, strategy, design system, architecture, code).',
                inputSchema: {
                    type: 'object',
                    properties: {
                        job_id: { type: 'string' },
