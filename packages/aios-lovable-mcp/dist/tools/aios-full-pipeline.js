...
export const fullPipelineSchema = {
    ...
    description: 'Execute end-to-end product development pipeline: strategy → design → architecture → code. Returns job_id for async tracking.',
    inputSchema: {
        type: 'object',
        properties: {
            product_name: {
            ...
            description: {
                type: 'string',
                description: 'Comprehensive product description, goals, and requirements',
            },
            target_segments: {
                type: 'array',
                items: { type: 'string' },
            ...
            webhook_url: {
                type: 'string',
                description: 'Webhook URL for real-time progress updates (receives POST with job status)',
            },
            phases: {
                type: 'array',
...
//# sourceMappingURL=aios-full-pipeline.js.map