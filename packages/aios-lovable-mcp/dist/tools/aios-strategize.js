...
export const strategizeSchema = {
    ...
    description: 'Generate comprehensive product strategy, market positioning, and PRD. Runs @pm agent (@analyst for market research).',
    inputSchema: {
        type: 'object',
        properties: {
            product_name: {
...
//# sourceMappingURL=aios-strategize.js.map