...
source: ".aios-core/development/tasks/improve-self.md"
---

# AIOS Task Skill: improve-self
...
## Source of Truth
- Load `.aios-core/development/tasks/improve-self.md`.
