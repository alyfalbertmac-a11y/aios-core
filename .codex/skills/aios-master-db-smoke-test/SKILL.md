---
name: aios-master-db-smoke-test
description: "Run post-migration validation checks"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-smoke-test.md"
---

# AIOS Task Skill: Task: DB Smoke Test
...
## Source of Truth
- Load `.aios-core/development/tasks/db-smoke-test.md`.
