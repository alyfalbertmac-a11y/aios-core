---
name: aios-master-qa-generate-tests
...
source: ".aios-core/development/tasks/qa-generate-tests.md"
---

# AIOS Task Skill: TODO: Create test-generation-checklist.md for validation (follow-up story needed)
...
## Source of Truth
- Load `.aios-core/development/tasks/qa-generate-tests.md`.
