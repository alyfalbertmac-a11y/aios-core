---
name: aios-master-db-apply-migration
description: "Safely apply a migration with pre/post snapshots and exclusive lock"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-apply-migration.md"
---

# AIOS Task Skill: Task: Apply Migration (with snapshot + advisory lock)
...
## Source of Truth
- Load `.aios-core/development/tasks/db-apply-migration.md`.
