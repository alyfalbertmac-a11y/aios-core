---
name: aios-master-db-rls-audit
description: "Report tables with/without RLS and list all policies"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-rls-audit.md"
---

# AIOS Task Skill: Task: RLS Audit
...
## Source of Truth
- Load `.aios-core/development/tasks/db-rls-audit.md`.
