---
name: aios-master-db-dry-run
description: "Execute migration inside BEGIN…ROLLBACK to catch syntax/ordering errors"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-dry-run.md"
---

# AIOS Task Skill: Task: Migration Dry-Run
...
## Source of Truth
- Load `.aios-core/development/tasks/db-dry-run.md`.
