---
name: aios-master-cleanup-utilities
...
source: ".aios-core/development/tasks/cleanup-utilities.md"
---

# AIOS Task Skill: Cleanup Utilities Task
...
## Source of Truth
- Load `.aios-core/development/tasks/cleanup-utilities.md`.
