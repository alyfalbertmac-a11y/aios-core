---
name: aios-devops-ci-cd-configuration
...
source: ".aios-core/development/tasks/ci-cd-configuration.md"
---

# AIOS Task Skill: Configure CI/CD Pipeline
...
## Source of Truth
- Load `.aios-core/development/tasks/ci-cd-configuration.md`.
