---
name: aios-master-update-manifest
...
source: ".aios-core/development/tasks/update-manifest.md"
---

# AIOS Task Skill: Update Manifest
...
## Source of Truth
- Load `.aios-core/development/tasks/update-manifest.md`.
