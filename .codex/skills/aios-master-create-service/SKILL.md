---
name: aios-master-create-service
...
source: ".aios-core/development/tasks/create-service.md"
---

# AIOS Task Skill: Create Service
...
## Source of Truth
- Load `.aios-core/development/tasks/create-service.md`.
