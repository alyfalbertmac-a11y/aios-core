---
name: aios-master-analyze-framework
...
source: ".aios-core/development/tasks/analyze-framework.md"
---

# AIOS Task Skill: Task: Analyze Framework
...
## Source of Truth
- Load `.aios-core/development/tasks/analyze-framework.md`.
