---
name: aios-master-test-validation-task
...
source: ".aios-core/development/tasks/test-validation-task.md"
---

# AIOS Task Skill: test-validation-task
...
## Source of Truth
- Load `.aios-core/development/tasks/test-validation-task.md`.
