---
name: aios-master-create-workflow
...
source: ".aios-core/development/tasks/create-workflow.md"
---

# AIOS Task Skill: TODO: Create workflow-validation-checklist.md for validation (follow-up story needed)
...
## Source of Truth
- Load `.aios-core/development/tasks/create-workflow.md`.
