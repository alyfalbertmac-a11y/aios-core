---
name: aios-master-ids-health
description: "Run a self-healing health check on the IDS entity registry to detect and auto-fix data integrity issues."
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/ids-health.md"
---

# AIOS Task Skill: IDS Registry Health Check Task
...
## Source of Truth
- Load `.aios-core/development/tasks/ids-health.md`.
