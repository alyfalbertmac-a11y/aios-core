---
name: aios-master-db-analyze-hotpaths
description: "Run EXPLAIN ANALYZE on common/critical queries to identify performance issues"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-analyze-hotpaths.md"
---

# AIOS Task Skill: Task: Analyze Hot Query Paths
...
## Source of Truth
- Load `.aios-core/development/tasks/db-analyze-hotpaths.md`.
