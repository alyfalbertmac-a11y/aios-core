---
name: aios-master-db-rollback
description: "Restore database to previous snapshot or run rollback script"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-rollback.md"
---

# AIOS Task Skill: Task: Rollback Database
...
## Source of Truth
- Load `.aios-core/development/tasks/db-rollback.md`.
