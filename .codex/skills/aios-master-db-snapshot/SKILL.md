---
name: aios-master-db-snapshot
description: "Create schema-only snapshot for rollback capability"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-snapshot.md"
---

# AIOS Task Skill: Task: Create Database Snapshot
...
## Source of Truth
- Load `.aios-core/development/tasks/db-snapshot.md`.
