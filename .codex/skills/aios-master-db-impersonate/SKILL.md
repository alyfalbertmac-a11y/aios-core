---
name: aios-master-db-impersonate
description: "Set session claims to emulate authenticated user for RLS testing"
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/db-impersonate.md"
---

# AIOS Task Skill: Task: Impersonate User (RLS Testing)
...
## Source of Truth
- Load `.aios-core/development/tasks/db-impersonate.md`.
