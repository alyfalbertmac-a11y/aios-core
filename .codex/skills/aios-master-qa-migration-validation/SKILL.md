---
name: aios-master-qa-migration-validation
description: "Validate database migrations are properly created and applied for schema changes."
owner: "master"
intent: "aios-task-workflow"
source: ".aios-core/development/tasks/qa-migration-validation.md"
---

# AIOS Task Skill: Migration Validation Task
...
## Source of Truth
- Load `.aios-core/development/tasks/qa-migration-validation.md`.
