---
name: aios-master-security-scan
...
source: ".aios-core/development/tasks/security-scan.md"
---

# AIOS Task Skill: security-scan
...
## Source of Truth
- Load `.aios-core/development/tasks/security-scan.md`.
